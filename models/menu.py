...
response.menu = [
    ...
    (T('Create Home'), False, URL('default','create_home'), []),
    (T('My Homes'), False, URL('default','my_homes'), []),
    (T('Join Home'), False, URL('default','join_home'), []),
    (T('Review Requests'), False, URL('default','review'), [])
    ]
